...
<head>
    ...
    <title>Installing PhalCMS</title>
                ...
                <div>
                    ...
                    <div class="uk-margin-small">
                        <input class="uk-input" name="dbName" type="text" id="dbName" autocomplete="off"
                               ...
                               required<?php echo $isEnvDev ? ' value="phalcms" disabled' : ''; ?>/>
                    </div>
                    <div class="uk-margin-small">
                ...
                <div>
                    ...
                    <div class="uk-margin-small">
                        <input class="uk-input" name="siteName" type="text" id="siteName" autocomplete="off"
                               placeholder="Enter your site name"<?php echo $isEnvDev ? ' value="PhalCMS site name"' : ''; ?> required/>
                    </div>
                    <div class="uk-margin-small">
