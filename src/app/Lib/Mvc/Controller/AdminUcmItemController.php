...
class AdminUcmItemController extends AdminControllerBase
{
    ...
    {
        $this->tag->title(Text::_($this->context . '-admin-index-title'));
    }
    ...
    protected function editTitle()
    {
        if ($this->model->id) {
            ...
            $this->tag->title(Text::_($this->context . '-admin-edit-title', $placeholders));
        } else {
            $this->tag->title(Text::_($this->context . '-admin-add-title'));
        }
    }
