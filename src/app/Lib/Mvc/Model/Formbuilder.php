...
class Formbuilder extends ModelBase
{
	/**
	 * @var integer
	 */
	...
	{
		return new Form('FilterForm', __DIR__ . '/Form/Formbuilder/Filter.php');
	}

	public function getFormsManager() : FormsManager
	{
		$formsManager = new FormsManager;
		$formsManager->set('general', new Form('FormData', __DIR__ . '/Form/Formbuilder/General.php'));
//		$formsManager->set('aside', new Form('FormData', __DIR__ . '/Form/UcmForm/Aside.php'));
//		$formsManager->set('metadata', new Form('FormData', __DIR__ . '/Form/Metadata/Metadata.php'));

		return $formsManager;
	}

	public function isContextPrefix($prefix) : bool
	{
		return preg_match('/^' . $prefix . '/', $this->context) ? true : false;
	}

	public function isContextSuffix($suffix) : bool
	{
