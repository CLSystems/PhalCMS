...
cmsCore.initTinyMCE = function (element, editorHeight) {
	...
	tinymce.init({
		...
		content_css: '{$rootUri}/assets/css/tinymce.css',
	...
	public static function initCodeMirror()
	{
		...
		if (!$initCodeMirror)
		{
			...
			Factory::getService('assets')
				->addCss(DOMAIN . '/assets/editors/codemirror/lib/codemirror.min.css', false)
				->addCss(DOMAIN . '/assets/editors/codemirror/lib/addons.min.css', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/lib/codemirror.min.js', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/lib/addons.min.js', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/mode/css/css.min.js', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/mode/xml/xml.min.js', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/mode/javascript/javascript.min.js', false)
				->addJs(DOMAIN . '/assets/editors/codemirror/mode/htmlmixed/htmlmixed.min.js', false)
